...
public class RegisterView {
    ...
    // Luodaan rekisteröintinäkymä. Ja palautetaan se Sceneoliona.

    // RegisterView register poistetaan parametreista sitten kun viewChanger implementoidaan (Nyt nää on tavallaan loopissa, eli registerView
    // palautuu loginView:n ja toisinpäin). Täytyy vähän siivota koodia.
    ...
    public Parent getView() {
        ...
        // nappien toiminta
         ...
         //back.setOnAction((event) -> viewChanger.viewBuilder(new LoginView(database, viewChanger).getView())); // Vahdetaan näkymää Login näkymäksi

        // otetaan tekstikentien arvot ja laitetaan ne createUser() metodiin joka on RegisterModelissa
